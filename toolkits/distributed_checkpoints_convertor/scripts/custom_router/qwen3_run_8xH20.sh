...
export PYTHONPATH=${MEGATRON_PATH}:${CONVERTOR_DIR}/impl:$PYTHONPATH
...
# A3B \
# /workspace/cache/models/Qwen3-30B-A3B \
# /workspace/xcx/Pai-Megatron-Patch/megatron_ckpt/custom_qwen_ckpt  \
# false \
# false \
# bf16